...
LR_OUT_DIR = "./Low_Res_Anisotropic"
HR_OUT_DIR = "./High_Res_Anisotropic"
...
def downsample_with_rician_noise(img_obj, noise_factor):
    """
    ...
    target_affine[0, 0] *= SCALE_X
    target_affine[1, 1] *= SCALE_Y
...
def main():
    ...
    for file in tqdm(files, desc="Processing Files", unit="file"):
        ...
        lr_img = downsample_with_rician_noise(img_4d, noise_factor=current_noise_level)
