...
from ResNetFifty import res_net_fifty
import numpy as np
...
valid_dataset = datasets.CIFAR10(root='./data', train=False, download=False, transform=transform)
...
if __name__ == "__main__":
    model = res_net_fifty(img_channels, num_classes, device=device).to(device)
